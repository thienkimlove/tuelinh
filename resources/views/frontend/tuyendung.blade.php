        ...
        <div class="fix">
            <div class="layout">
                <div class="layout-left">
                    <div class="box-news">
                        <div class="head">
                            <h1 class="title wow fade-in-left">Tuyển dụng</h1>
                            <p class="des wow fade-in-right">Yếu tố con người là nguồn lực then chốt giúp chúng tôi tồn tại và phát triển</p>
                        </div>
