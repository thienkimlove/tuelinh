                ...
                <div class="layout-right">
                    <div class="item">
                        <ul class="list-menu">
                            ...
                            <li><a href="">Hội đồng chuyên môn</a></li>
                            <li><a href="">Hội nhập và phát triển</a></li>
                            <li><a href="">Vùng nguyên liệu sạch</a></li>
                            <li><a href="">Giám sát chất lượng</a></li>
                            <li><a href="">Giây chuyền sản xuất</a></li>
